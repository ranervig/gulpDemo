...
function displayInstructions(instructions, instClass) {
  let div = document.createElement("div");
...
function changeServings(serving){
  ...
  displayRecipe(
    ...
    document.querySelector("#instructionList").className
  );
}
